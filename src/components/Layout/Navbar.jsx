...
export default function Navbar({ onNewInvoice, sidebarOpen, onToggleSidebar }) {
  ...
  return (
    <>
      <div className="sidebar-overlay" style={{ display: sidebarOpen ? 'block' : 'none' }} onClick={() => onToggleSidebar(false)} />
      <aside className={`sidebar${sidebarOpen ? ' open' : ''}`}>
        ...
        <div className="sidebar-footer">
          <button className="btn btn-primary btn-sm" onClick={() => { onNewInvoice(); if (onToggleSidebar) onToggleSidebar(false); }} style={{ width: '100%', marginBottom: 8 }}>
            + New Invoice
          </button>
          <button
